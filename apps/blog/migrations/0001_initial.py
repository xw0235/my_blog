# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-07-04 15:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='谈谈技术,写写生活,聊聊人生,吹吹牛逼', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
            ],
            options={
                'verbose_name': '分类',
